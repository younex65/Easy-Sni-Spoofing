...
create_config() {
  ...
  \"listeners\": ["
    ...
    print_info "How many listeners do you want? (default 1):"
    read -r listener_count
    ...
    for ((i=1; i<=listener_count; i++)); do
        ...
        # listen
        while true; do
            print_info "Listen address (e.g., 0.0.0.0):"
            read -r listen_ip
        ...
        while true; do
            print_info "Listen port (e.g., 40443):"
            read -r listen_port
        ...
        # connect
        while true; do
            print_info "Connect address (IP or domain, e.g., 198.41.194.170):"
            read -r connect_ip
        ...
        while true; do
            print_info "Connect port (e.g., 443):"
            read -r connect_port
        ...
        # fake_sni
        print_info "fake_sni (spoofed SNI, e.g., 198.41.194.170 or google.com):"
        read -r fake_sni
